...
# Nyc
DEFINES   += BIP44_COIN_TYPE=3 BIP44_COIN_TYPE_2=3 COIN_P2PKH_VERSION=30 COIN_P2SH_VERSION=22 COIN_FAMILY=1 COIN_COINID=\"Newyorkcoin\" COIN_COINID_HEADER=\"NEWYORKCOIN\" COIN_COLOR_HDR=0x65D196 COIN_COLOR_DB=0xB2E8CB COIN_COINID_NAME=\"Newyorkcoin\" COIN_COINID_SHORT=\"NYC\" COIN_KIND=COIN_KIND_NYC
APPNAME ="Newyorkcoin"
APP_LOAD_PARAMS += --path $(APP_PATH)
else ifeq ($(COIN),quebecoin)
# Qbc
DEFINES   += BIP44_COIN_TYPE=3 BIP44_COIN_TYPE_2=3 COIN_P2PKH_VERSION=30 COIN_P2SH_VERSION=22 COIN_FAMILY=1 COIN_COINID=\"Quebecoin\" COIN_COINID_HEADER=\"QUEBECOIN\" COIN_COLOR_HDR=0x65D196 COIN_COLOR_DB=0xB2E8CB COIN_COINID_NAME=\"Quebecoin\" COIN_COINID_SHORT=\"QBC\" COIN_KIND=COIN_KIND_QBC
APPNAME ="Quebecoin"
APP_LOAD_PARAMS += --path $(APP_PATH)
else ifeq ($(COIN),dash)
# Dash
